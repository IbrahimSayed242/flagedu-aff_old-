          ...
          <div class="bg-light rounded py-5 px-4">
            ...
            <form @submit.prevent="handleFormSubmit" id="form">
              ...
              <div class="form-check">
                ...
                <ul class="text-muted">
                  <li>- استخدم من 8 إلى 15 حرفا</li>
                  <li>- استخدم كل من الأحرف الكبيرة والصغيرة</li>
                  <li>- استخدم مجموعة من الأرقام والحروف الإنجليزية</li>
                  <li>- استخدم أحرف خاصة او رموز</li>
                </ul>
              </div>
...
export default class ExnessCC extends Vue {
