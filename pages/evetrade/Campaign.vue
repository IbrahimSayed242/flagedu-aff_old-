<template>
  <div>
    <div class="bg-eve container-fluid p-0 m-0">
      ...
      <div class="header-cont" dir="rtl">
        <div class="head-right-two-image">
          ...
          <button
            type="button"
            class="btn btn-info m-3 p-2 fs-3 font-weight-bold rounded-0 button-c"
        ...
        <div class="video-box">
          ...
          <div class="video-bottom-image">
            <img
              src="https://images.clickfunnels.com/cdn-cgi/image/width=1000px,fit=scale-down,f=auto,q=80/https://statics.myclickfunnels.com/image/1436828/file/2126cde56d95b1b1a3fc7501e253de61.png"
            />
          </div>
        </div>
      </div>
      ...
      <div
        class="text-center bg-white px-0 m-auto d-flex flex-column m-auto justify-content-center"
      >
        <div
        ...
        <a
          type="button"
          class="rounded-0 btn btn-info m-3 p-2 fs-3 font-weight-bold col-5 m-auto button-2nd"
          data-bs-toggle="modal"
          data-bs-target="#exampleModal"
        >
          <<سجل الآن >>
    ...
    <div class="text-center my-3 d-flex flex-column justify-content-center">
      <div class="d-flex justify-content-center">
        <div class="col-7">
          <h2 class="text-info">اتصل بنا</h2>
          <div class="text-center">
            <p class="support-text">support@eve-invest.com</p>
            <p class="working-hour">Working hours: 9:00 to 18:00 CET</p>
            <p class="bottom-text">
...
export default class EveTrade extends Vue {
  ...
  async asyncData({ route, $axios, store, error, req }) {
    ...
    var brand = "evetrade";
    var creative_name = "EveTrade Campaign";
    var ci = null;
...
.video-box {
  ...
  .video-player-box {
    height: 280px;
    width: 500px;
    box-shadow: 0px 0px 7px 7px #aab7c7 !important;
    border-radius: 4px !important;
    border-style: solid !important;
    border-color: rgb(23, 225, 245) !important;
  ...
  .video-bottom-image {
    img {
      ...
      height: 150px;
      margin-top: 50px;
      box-shadow: 0px 0px 0px 3px rgb(52, 247, 247);
